#Astrocrash 01
#Tworzy poruszające się asteroidy
...
class Asteroid(games.Sprite):
    ...
    def update(self):
        """Przenoszenie asteroidy na przeciwległy przeg ekranu"""
...
class Ship(games.Sprite):
    ...
    def update(self):
        """Obracanie statku zgodnie z naciśniętym klawiszem"""
